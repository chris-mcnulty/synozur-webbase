    ...
    <div className="w-full overflow-x-hidden selection:bg-primary/30">
      ...
      <section className="relative overflow-hidden border-y border-border">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6 py-24 text-center max-w-3xl">
          <motion.h2 {...fadeUp} className="text-3xl md:text-5xl font-bold text-white leading-tight">
      ...
      <section id="book" className="relative overflow-hidden border-t border-border py-28">
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6 max-w-5xl">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <motion.p {...fadeUp} className="text-sm uppercase tracking-[0.25em] text-primary mb-4">
              The next step
            </motion.p>
            <motion.h2
              {...fadeUp}
