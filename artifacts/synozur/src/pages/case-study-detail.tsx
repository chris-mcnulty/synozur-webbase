        ...
        <section className="py-12 bg-background">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className={`grid grid-cols-1 gap-4 ${[study.atAGlance, study.whatWeDid, study.whyItWorked].filter(Boolean).length === 2 ? "md:grid-cols-2" : "md:grid-cols-3"}`}>
              {study.atAGlance && (
                <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-800/80 p-6">
                  <p className="text-xs uppercase tracking-widest text-violet-600 dark:text-violet-400 mb-3 font-semibold">At a Glance</p>
                  <p className="text-sm text-zinc-700 dark:text-zinc-200 leading-relaxed">{study.atAGlance}</p>
                </div>
              )}
              {study.whatWeDid && (
                <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-800/80 p-6">
                  <p className="text-xs uppercase tracking-widest text-violet-600 dark:text-violet-400 mb-3 font-semibold">What We Did</p>
                  <p className="text-sm text-zinc-700 dark:text-zinc-200 leading-relaxed">{study.whatWeDid}</p>
                </div>
              )}
              {study.whyItWorked && (
                <div className="rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-800/80 p-6">
                  <p className="text-xs uppercase tracking-widest text-violet-600 dark:text-violet-400 mb-3 font-semibold">Why It Worked</p>
                  <p className="text-sm text-zinc-700 dark:text-zinc-200 leading-relaxed">{study.whyItWorked}</p>
                </div>
              )}
            </div>
          </div>
