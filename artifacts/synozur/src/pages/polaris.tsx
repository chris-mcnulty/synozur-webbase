...
const episodes = [
  { num: "06", title: "Operating cadence in a 100,000-person company", guest: "CSO, Global Industrial", length: "47 min", image: "/images/polaris-ep-06.png" },
  { num: "05", title: "Why responsible AI is finally a board topic", guest: "CIO, Healthcare Network", length: "52 min", image: "/images/polaris-ep-05.png" },
  { num: "04", title: "Designing the Monday morning experience", guest: "Chief People Officer, Tech", length: "39 min", image: "/images/polaris-ep-04.png" },
  { num: "03", title: "Repositioning a category leader", guest: "CEO, Enterprise SaaS", length: "44 min", image: "/images/polaris-ep-03.png" },
  { num: "02", title: "Fractional leadership in the executive suite", guest: "Operating Partner, PE", length: "41 min", image: "/images/polaris-ep-02.png" },
  { num: "01", title: "Finding your North Star", guest: "Synozur Founders", length: "55 min", image: "/images/polaris-ep-01.png" },
];
            ...
            {episodes.map((e, i) => (
              ...
              >
                <div className="relative aspect-square overflow-hidden bg-card">
                  ...
                  <div className="absolute top-5 right-5 text-white text-sm font-bold tracking-tighter">
                    POLARIS
                  </div>
