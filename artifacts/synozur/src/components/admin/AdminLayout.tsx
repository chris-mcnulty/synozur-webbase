...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/access/clients", label: "Client orgs", icon: Briefcase, capability: "client_orgs.manage", testId: "nav-admin-client-orgs" },
      { href: "/access/organizations", label: "Organizations", icon: UsersRound, capability: "client_orgs.manage", testId: "nav-admin-organizations" },
